...
const configuracion = {
  ...
  baseDatos: {
    url: process.env.DATABASE_URL || 'postgresql://usuario:password@localhost:5432/wms_ranco_cherries'
  },
  
  jwt: {
    secreto: process.env.JWT_SECRET || 'mi-secreto-super-seguro-para-jwt-ranco-cherries-2024',
  ...
  cors: {
    origen: process.env.CORS_ORIGIN || ['http://localhost:3000', 'http://127.0.0.1:3000'],
    credentials: true
  },
