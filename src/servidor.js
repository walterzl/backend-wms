...
class Servidor {
  ...
  configurarRutas() {
    ...
    this.app.get('/api/mantenedores/plantas', ControladorMantenedores.obtenerPlantas);
    this.app.get('/api/mantenedores/materiales', ControladorMantenedores.obtenerMateriales);
    this.app.get('/api/mantenedores/proveedores', ControladorMantenedores.obtenerProveedores);
    this.app.get('/api/mantenedores/ubicaciones', ControladorMantenedores.obtenerUbicaciones);
    this.app.get('/api/mantenedores/temporadas', ControladorMantenedores.obtenerTemporadas);
    this.app.get('/api/mantenedores/tipos-movimiento', ControladorMantenedores.obtenerTiposMovimiento);
    this.app.get('/api/mantenedores/unidades-medida', ControladorMantenedores.obtenerUnidadesMedida);
...
│  Puerto: ${this.puerto}                                              │
│  Entorno: ${configuracion.servidor.entorno}                                     │
│  Versión: ${configuracion.aplicacion.version}                                        │
